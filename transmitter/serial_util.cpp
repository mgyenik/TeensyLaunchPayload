...
// Some floating point formatting routine I yoinked from the internet since
// dtostrf for the teensy is BROKEN. SERIOUSLY:
// char fuck[16];
// dtostrf(0.01f, 7, 4, fuck);
// Serial.print("wat :");
// Serial.println(fuck);
// dtostrf(0.005f, 7, 4, fuck);
// Serial.print("wat :");
// Serial.println(fuck);
// dtostrf(1.02f, 7, 4, fuck);
// Serial.print("wat :");
// Serial.println(fuck);
// Serial.println("wat - " + String(.005f));
//
// Results in:
// wat :   100
// wat :    50
